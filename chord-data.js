...
'Cdim7':   { frets: [x, 3, 4, 2, 4, 2], fingers: [0, 2, 3, 1, 4, 1] },
'C#dim7':  { frets: [x, 4, 5, 3, 5, 3], fingers: [0, 2, 3, 1, 4, 1] },
'Dbdim7':  { frets: [x, 4, 5, 3, 5, 3], fingers: [0, 2, 3, 1, 4, 1] },
'Ddim7':   { frets: [x, 5, 6, 4, 6, 4], fingers: [0, 2, 3, 1, 4, 1] },
'D#dim7':  { frets: [x, 6, 7, 5, 7, 5], fingers: [0, 2, 3, 1, 4, 1] },
'Ebdim7':  { frets: [x, 6, 7, 5, 7, 5], fingers: [0, 2, 3, 1, 4, 1] },
'Edim7':   { frets: [x, 7, 8, 6, 8, 6], fingers: [0, 2, 3, 1, 4, 1] },
'Fdim7':   { frets: [x, 8, 9, 7, 9, 7], fingers: [0, 2, 3, 1, 4, 1] },
'F#dim7':  { frets: [x, 9, 10, 8, 10, 8], fingers: [0, 2, 3, 1, 4, 1] },
'Gbdim7':  { frets: [x, 9, 10, 8, 10, 8], fingers: [0, 2, 3, 1, 4, 1] },
'Gdim7':   { frets: [x, 10, 11, 9, 11, 9], fingers: [0, 2, 3, 1, 4, 1] },
'G#dim7':  { frets: [x, 11, 12, 10, 12, 10], fingers: [0, 2, 3, 1, 4, 1] },
'Abdim7':  { frets: [x, 11, 12, 10, 12, 10], fingers: [0, 2, 3, 1, 4, 1] },
'Adim7':   { frets: [x, 12, 13, 11, 13, 11], fingers: [0, 2, 3, 1, 4, 1] },
'A#dim7':  { frets: [x, 1, 2, 0, 2, 0], fingers: [0, 2, 3, 0, 4, 0] },
'Bbdim7':  { frets: [x, 1, 2, 0, 2, 0], fingers: [0, 2, 3, 0, 4, 0] },
'Bdim7':   { frets: [x, 2, 3, 1, 3, 1], fingers: [0, 2, 3, 1, 4, 1] },
