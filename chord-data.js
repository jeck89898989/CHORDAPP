export const chordDefinitions = {
    ...
    // Add comprehensive missing chord diagrams for complete coverage

    // Eb equivalents and extensions
    'Ebm7': { frets: [-1, -1, 1, 3, 2, 2], fingers: [0, 0, 1, 3, 2, 2] },
    'Ebmaj7b5': { frets: [-1, -1, 1, 2, 3, 3], fingers: [0, 0, 1, 2, 3, 4] },
    'Ebdim': { frets: [-1, -1, 1, 2, 1, 2], fingers: [0, 0, 1, 3, 2, 4] },
    'Ebdim7': { frets: [-1, -1, 1, 2, 1, 2], fingers: [0, 0, 1, 3, 2, 4] },
    'Ebaug': { frets: [-1, -1, 1, 0, 0, 3], fingers: [0, 0, 2, 0, 0, 4] },
    'Ebsus2': { frets: [-1, -1, 1, 3, 4, 1], fingers: [0, 0, 1, 2, 4, 1] },
    'Ebsus4': { frets: [-1, -1, 1, 3, 4, 4], fingers: [0, 0, 1, 2, 3, 4] },
    'Eb9': { frets: [-1, -1, 1, 0, 2, 1], fingers: [0, 0, 1, 0, 3, 2] },
    'Eb6': { frets: [-1, -1, 1, 3, 1, 3], fingers: [0, 0, 1, 4, 2, 3] },
    'Ebm6': { frets: [-1, -1, 1, 3, 2, 4], fingers: [0, 0, 1, 3, 2, 4] },
    'Ebadd9': { frets: [-1, -1, 1, 0, 4, 3], fingers: [0, 0, 1, 0, 4, 3] },
    'Ebm(add9)': { frets: [-1, -1, 1, 0, 4, 2], fingers: [0, 0, 1, 0, 4, 2] },

    // Ab equivalents and extensions
    'Abm7': { frets: [4, 6, 4, 4, 4, 4], fingers: [1, 3, 1, 1, 1, 1] },
    'Abmaj7b5': { frets: [4, 3, 1, 1, 2, 3], fingers: [4, 3, 1, 1, 2, 3] },
    'Abdim': { frets: [4, 5, 6, 4, 6, 4], fingers: [1, 2, 4, 1, 3, 1] },
    'Abdim7': { frets: [4, 5, 6, 4, 6, 4], fingers: [1, 2, 4, 1, 3, 1] },
    'Abaug': { frets: [4, 3, 2, 1, 1, 4], fingers: [4, 3, 2, 1, 1, 4] },
    'Absus2': { frets: [4, 6, 6, 6, 4, 4], fingers: [1, 2, 3, 4, 1, 1] },
    'Absus4': { frets: [4, 6, 6, 6, 6, 4], fingers: [1, 2, 3, 4, 4, 1] },
    'Ab9': { frets: [4, 3, 1, 1, 1, 6], fingers: [3, 2, 1, 1, 1, 4] },
    'Ab6': { frets: [4, 3, 1, 1, 1, 1], fingers: [4, 3, 1, 1, 1, 2] },
    'Abm6': { frets: [4, 6, 4, 4, 4, 1], fingers: [2, 4, 2, 2, 3, 1] },
    'Abadd9': { frets: [4, 3, 1, 1, 4, 6], fingers: [3, 2, 1, 1, 4, 4] },
    'Abm(add9)': { frets: [4, 6, 4, 4, 6, 4], fingers: [1, 3, 1, 1, 4, 1] },

    // Bb equivalents and extensions  
    'Bbm7': { frets: [-1, 1, 3, 1, 2, 1], fingers: [0, 1, 3, 1, 2, 1] },
    'Bbmaj7b5': { frets: [-1, 1, 3, 2, 2, 1], fingers: [0, 1, 4, 2, 3, 1] },
    'Bbdim': { frets: [-1, 1, 2, 0, 2, 0], fingers: [0, 1, 3, 0, 2, 0] },
    'Bbdim7': { frets: [-1, 1, 2, 0, 2, 0], fingers: [0, 1, 3, 0, 2, 0] },
    'Bbaug': { frets: [-1, 1, 0, 3, 3, 2], fingers: [0, 1, 0, 3, 4, 2] },
    'Bbsus2': { frets: [-1, 1, 3, 3, 1, 1], fingers: [0, 1, 3, 4, 1, 2] },
    'Bbsus4': { frets: [-1, 1, 3, 3, 4, 1], fingers: [0, 1, 2, 3, 4, 1] },
    'Bb9': { frets: [-1, 1, 0, 1, 1, 1], fingers: [0, 1, 0, 2, 3, 4] },
    'Bb6': { frets: [-1, 1, 3, 0, 3, 1], fingers: [0, 1, 4, 0, 3, 2] },
    'Bbm6': { frets: [-1, 1, 3, 0, 2, 1], fingers: [0, 1, 4, 0, 3, 2] },
    'Bbadd9': { frets: [-1, 1, 0, 3, 3, 1], fingers: [0, 1, 0, 3, 4, 2] },
    'Bbm(add9)': { frets: [-1, 1, 0, 3, 2, 1], fingers: [0, 1, 0, 4, 3, 2] },

    // Add missing basic chords for all enharmonic equivalents
    'Db6': { frets: [-1, 4, 3, 1, 2, 1], fingers: [0, 4, 3, 1, 2, 1] },
    'Dbm6': { frets: [-1, 4, 6, 6, 5, 1], fingers: [0, 1, 3, 4, 2, 1] },
    'Dbadd9': { frets: [-1, 4, 3, 1, 4, 6], fingers: [0, 3, 2, 1, 4, 4] },
    'Dbm(add9)': { frets: [-1, 4, 6, 6, 7, 4], fingers: [0, 1, 2, 3, 4, 1] },
    'Dbdim': { frets: [-1, 4, 5, 3, 5, 3], fingers: [0, 2, 4, 1, 3, 1] },
    'Dbdim7': { frets: [-1, 4, 5, 3, 5, 3], fingers: [0, 2, 4, 1, 3, 1] },
    'Dbaug': { frets: [-1, 4, 3, 2, 2, 1], fingers: [0, 4, 3, 1, 2, 1] },
    'Dbsus2': { frets: [-1, 4, 6, 6, 4, 4], fingers: [0, 1, 3, 4, 1, 2] },
    'Dbsus4': { frets: [-1, 4, 6, 6, 7, 4], fingers: [0, 1, 2, 3, 4, 1] },
    'Db9': { frets: [-1, 4, 3, 4, 4, 4], fingers: [0, 2, 1, 3, 4, 4] },

    // Add missing Gb variants
    'Gbm6': { frets: [2, 4, 4, 2, 4, 2], fingers: [1, 3, 4, 1, 4, 2] },
    'Gbadd9': { frets: [2, 4, 4, 3, 4, 4], fingers: [1, 3, 4, 2, 4, 4] },
    'Gbm(add9)': { frets: [2, 4, 4, 2, 5, 2], fingers: [1, 3, 4, 1, 4, 2] },
    'Gbdim': { frets: [2, 3, 4, 2, 4, 2], fingers: [1, 2, 4, 1, 3, 1] },
    'Gbdim7': { frets: [2, 3, 4, 2, 4, 2], fingers: [1, 2, 4, 1, 3, 1] },
    'Gbaug': { frets: [2, 4, 4, 3, 3, 2], fingers: [1, 3, 4, 2, 2, 1] },
    'Gbsus2': { frets: [2, 4, 4, 4, 2, 2], fingers: [1, 2, 3, 4, 1, 1] },
    'Gbsus4': { frets: [2, 4, 4, 4, 5, 2], fingers: [1, 2, 3, 4, 4, 1] },
    'Gb9': { frets: [2, 4, 2, 3, 2, 4], fingers: [1, 4, 1, 3, 1, 4] },
    'Gb6': { frets: [2, 4, 3, 3, 2, 2], fingers: [1, 4, 2, 3, 1, 1] },

    // More C# variants
    'C#6': { frets: [-1, 4, 3, 1, 1, 4], fingers: [0, 4, 3, 1, 2, 4] },
    'C#m6': { frets: [-1, 4, 6, 6, 5, 6], fingers: [0, 1, 2, 3, 1, 4] },
    'C#add9': { frets: [-1, 4, 3, 1, 4, 4], fingers: [0, 3, 2, 1, 4, 4] },
    'C#m(add9)': { frets: [-1, 4, 6, 6, 7, 4], fingers: [0, 1, 2, 3, 4, 1] },
    'C#dim': { frets: [-1, 4, 5, 3, 5, 3], fingers: [0, 2, 4, 1, 3, 1] },
    'C#dim7': { frets: [-1, 4, 5, 3, 5, 3], fingers: [0, 2, 4, 1, 3, 1] },
    'C#aug': { frets: [-1, 4, 3, 2, 2, 1], fingers: [0, 4, 3, 1, 2, 1] },
    'C#sus2': { frets: [-1, 4, 6, 6, 4, 4], fingers: [0, 1, 3, 4, 1, 2] },
    'C#sus4': { frets: [-1, 4, 6, 6, 7, 4], fingers: [0, 1, 2, 3, 4, 1] },
    'C#9': { frets: [-1, 4, 3, 4, 4, 4], fingers: [0, 2, 1, 3, 4, 4] },

    // More F# variants
    'F#m6': { frets: [2, 4, 4, 2, 4, 2], fingers: [1, 3, 4, 1, 4, 2] },
    'F#add9': { frets: [2, 4, 4, 3, 4, 4], fingers: [1, 3, 4, 2, 4, 4] },
    'F#m(add9)': { frets: [2, 4, 4, 2, 5, 2], fingers: [1, 3, 4, 1, 4, 2] },
    'F#dim': { frets: [2, 3, 4, 2, 4, 2], fingers: [1, 2, 4, 1, 3, 1] },
    'F#dim7': { frets: [2, 3, 4, 2, 4, 2], fingers: [1, 2, 4, 1, 3, 1] },
    'F#aug': { frets: [2, 4, 4, 3, 3, 2], fingers: [1, 3, 4, 2, 2, 1] },
    'F#sus2': { frets: [2, 4, 4, 4, 2, 2], fingers: [1, 2, 3, 4, 1, 1] },
    'F#sus4': { frets: [2, 4, 4, 4, 5, 2], fingers: [1, 2, 3, 4, 4, 1] },
    'F#9': { frets: [2, 4, 2, 3, 2, 4], fingers: [1, 4, 1, 3, 1, 4] },
    'F#6': { frets: [2, 4, 3, 3, 2, 2], fingers: [1, 4, 2, 3, 1, 1] },

    // More G# variants
    'G#m6': { frets: [4, 6, 6, 4, 6, 4], fingers: [1, 3, 4, 1, 4, 2] },
    'G#add9': { frets: [4, 3, 1, 1, 4, 6], fingers: [3, 2, 1, 1, 4, 4] },
    'G#m(add9)': { frets: [4, 6, 6, 4, 7, 4], fingers: [1, 2, 3, 1, 4, 1] },
    'G#dim': { frets: [4, 5, 6, 4, 6, 4], fingers: [1, 2, 4, 1, 3, 1] },
    'G#dim7': { frets: [4, 5, 6, 4, 6, 4], fingers: [1, 2, 4, 1, 3, 1] },
    'G#aug': { frets: [4, 3, 2, 1, 1, 4], fingers: [4, 3, 2, 1, 1, 4] },
    'G#sus2': { frets: [4, 6, 6, 6, 4, 4], fingers: [1, 2, 3, 4, 1, 1] },
    'G#sus4': { frets: [4, 6, 6, 6, 6, 4], fingers: [1, 2, 3, 4, 4, 1] },
    'G#9': { frets: [4, 3, 1, 1, 1, 6], fingers: [3, 2, 1, 1, 1, 4] },
    'G#6': { frets: [4, 3, 1, 1, 1, 1], fingers: [4, 3, 1, 1, 1, 2] },

    // More A# variants
    'A#6': { frets: [-1, 1, 3, 0, 3, 1], fingers: [0, 1, 4, 0, 3, 2] },
    'A#m6': { frets: [-1, 1, 3, 0, 2, 1], fingers: [0, 1, 4, 0, 3, 2] },
    'A#add9': { frets: [-1, 1, 0, 3, 3, 1], fingers: [0, 1, 0, 3, 4, 2] },
    'A#m(add9)': { frets: [-1, 1, 0, 3, 2, 1], fingers: [0, 1, 0, 4, 3, 2] },
    'A#dim': { frets: [-1, 1, 2, 0, 2, 0], fingers: [0, 1, 3, 0, 2, 0] },
    'A#dim7': { frets: [-1, 1, 2, 0, 2, 0], fingers: [0, 1, 3, 0, 2, 0] },
    'A#aug': { frets: [-1, 1, 0, 3, 3, 2], fingers: [0, 1, 0, 3, 4, 2] },
    'A#sus2': { frets: [-1, 1, 3, 3, 1, 1], fingers: [0, 1, 3, 4, 1, 2] },
    'A#sus4': { frets: [-1, 1, 3, 3, 4, 1], fingers: [0, 1, 2, 3, 4, 1] },
    'A#9': { frets: [-1, 1, 0, 1, 1, 1], fingers: [0, 1, 0, 2, 3, 4] },

    // Additional missing extended chords for popular keys
    ...
    // Power chords for all keys
    'C5': { frets: [-1, 3, 5, 5, -1, -1], fingers: [0, 1, 3, 4, 0, 0] },
    'C#5': { frets: [-1, 4, 6, 6, -1, -1], fingers: [0, 1, 3, 4, 0, 0] },
    'Db5': { frets: [-1, 4, 6, 6, -1, -1], fingers: [0, 1, 3, 4, 0, 0] },
    'D5': { frets: [-1, -1, 0, 2, 3, -1], fingers: [0, 0, 0, 1, 2, 0] },
    'D#5': { frets: [-1, -1, 1, 3, 4, -1], fingers: [0, 0, 1, 2, 3, 0] },
    'Eb5': { frets: [-1, -1, 1, 3, 4, -1], fingers: [0, 0, 1, 2, 3, 0] },
    ...
    'Gb5': { frets: [2, 4, 4, -1, -1, -1], fingers: [1, 2, 3, 0, 0, 0] },
    'G5': { frets: [3, 5, 5, -1, -1, -1], fingers: [1, 2, 3, 0, 0, 0] },
    'G#5': { frets: [4, 6, 6, -1, -1, -1], fingers: [1, 2, 3, 0, 0, 0] },
    'Ab5': { frets: [4, 6, 6, -1, -1, -1], fingers: [1, 2, 3, 0, 0, 0] },
    'A5': { frets: [-1, 0, 2, 2, -1, -1], fingers: [0, 0, 1, 2, 0, 0] },
    'A#5': { frets: [-1, 1, 3, 3, -1, -1], fingers: [0, 1, 2, 3, 0, 0] },
    'Bb5': { frets: [-1, 1, 3, 3, -1, -1], fingers: [0, 1, 2, 3, 0, 0] },
    'B5': { frets: [-1, 2, 4, 4, -1, -1], fingers: [0, 1, 2, 3, 0, 0] },

    // Slash chords for common progressions
    ...
    'Am/C': { frets: [-1, 3, 2, 2, 1, 0], fingers: [0, 4, 3, 2, 1, 0] },
    'Am/E': { frets: [0, 0, 2, 2, 1, 0], fingers: [0, 0, 2, 3, 1, 0] },
    'Dm/F': { frets: [1, -1, 0, 2, 3, 1], fingers: [1, 0, 0, 2, 4, 1] },
    'Em/B': { frets: [-1, 2, 2, 0, 0, 0], fingers: [0, 1, 2, 0, 0, 0] },

    // Jazz chord extensions for all keys
    'C13': { frets: [-1, 3, 2, 2, 4, 5], fingers: [0, 2, 1, 1, 3, 4] },
    'D13': { frets: [-1, -1, 0, 2, 2, 4], fingers: [0, 0, 0, 1, 2, 4] },
    'E13': { frets: [0, 2, 1, 1, 0, 4], fingers: [0, 2, 1, 1, 0, 4] },
    'F13': { frets: [1, 3, 2, 2, 4, 5], fingers: [1, 3, 2, 2, 4, 4] },
    'G13': { frets: [3, 2, 0, 2, 4, 5], fingers: [2, 1, 0, 2, 3, 4] },
    'A13': { frets: [-1, 0, 2, 1, 2, 4], fingers: [0, 0, 2, 1, 3, 4] },
    'B13': { frets: [-1, 2, 4, 3, 4, 6], fingers: [0, 1, 2, 1, 3, 4] },

    // More chord extensions with enharmonics
    'Db13': { frets: [-1, 4, 3, 1, 5, 6], fingers: [0, 3, 2, 1, 4, 4] },
    'Eb13': { frets: [-1, -1, 1, 3, 3, 5], fingers: [0, 0, 1, 2, 3, 4] },
    'Gb13': { frets: [2, 4, 3, 3, 5, 6], fingers: [1, 3, 2, 2, 4, 4] },
    'Ab13': { frets: [4, 3, 1, 1, 6, 8], fingers: [2, 1, 1, 1, 3, 4] },
    'Bb13': { frets: [-1, 1, 3, 2, 3, 5], fingers: [0, 1, 3, 2, 4, 4] },

    // Commonly used jazz voicings
    'Cm9': { frets: [-1, 3, 1, 3, 3, 3], fingers: [0, 2, 1, 2, 3, 4] },
    'Dm9': { frets: [-1, -1, 0, 2, 1, 0], fingers: [0, 0, 0, 2, 1, 0] },
    'Em9': { frets: [0, 2, 0, 0, 0, 2], fingers: [0, 2, 0, 0, 0, 3] },
    'Fm9': { frets: [1, 3, 1, 1, 1, 3], fingers: [1, 3, 1, 1, 1, 4] },
    'Gm9': { frets: [3, 5, 3, 3, 3, 3], fingers: [1, 3, 1, 1, 1, 1] },
    'Am9': { frets: [-1, 0, 2, 4, 2, 3], fingers: [0, 0, 1, 4, 2, 3] },
